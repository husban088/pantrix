...
const reasons = [
  // Full Stack Development
  {
    ...
    desc: "React, Next.js, Angular, Vue.js, Node.js, Express.js, Supabase, Firebase, MongoDB, Cloudinary — I handle the full stack. Blazing UIs, scalable APIs, and zero compromise on quality.",
  ...
  // Mobile App Development
  {
    ...
    desc: "React Native & Expo — I build cross-platform mobile apps backed by the same solid Node.js, Express.js, Firebase, Supabase, MongoDB & Cloudinary APIs that power the web.",
